...
const Step8V = ({
  ...
  const enfermedadesBase = [
    { id: "leucemia", nombre: "Leucemia" },
    { id: "tumores_malignos", nombre: "Tumores malignos" },
    { id: "sida_vih", nombre: "Sida o VIH positivo" },
    { id: "insuficiencia_renal", nombre: "Insuficiencia renal" },
    { id: "esclerosis_multiple", nombre: "Esclerosis múltiple" },
    { id: "artritis_reumatoidea", nombre: "Artritis reumatoidea" },
  ];
  ...
  /* =========================
     ASEGURADOS YA USADOS EN OTROS STEPS
  ========================= */
  ...
  ========================= */
  useEffect(() => {
    const prevData = initialData?.enfermedadesStep8 || [];
  ...
  const handleAddInput = (id) => {
    setFormData(prev => ({
      ...
      enfermedades: prev.enfermedades.map(e => {
        ...
        const camposVacios = e.asegurados.some(a => !a.asegurado || !a.medico || !a.institucion || !a.eps);
        if (camposVacios) {
  ...
  const handleSubmit = (e) => {
    ...
    setEnfermedadErrors({});
    onNext({ enfermedadesStep8: formData.enfermedades });
  };

  const handlePrevious = (e) => {
    e.preventDefault();
    onPrevious({ enfermedadesStep8: formData.enfermedades });
  };
  ...
  return (
    <div className={styles.formCard}>
      ...
      <h2 className={styles.sectionTitle}>
        3. Usted o alguien de su grupo familiar sufre o ha sido tratado por:
